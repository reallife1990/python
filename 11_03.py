...
Подсказка: для этого задания примем, что пользователь может вводить
    ...
    ввести текст (не число) и отобразить соответствующее сообщение. При этом
...
while True:
    ...
    if income == 'stop':
        ...
        try:
            ...
            #raise Number(' не число, попробуйте заново')
            print(' не число, попробуйте заново')